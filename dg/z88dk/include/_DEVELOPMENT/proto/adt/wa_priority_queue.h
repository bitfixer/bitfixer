...
__DPROTO(size_t,,wa_priority_queue_capacity,wa_priority_queue_t *q)
__DPROTO(void,,wa_priority_queue_clear,wa_priority_queue_t *q)
__DPROTO(void,*,wa_priority_queue_data,wa_priority_queue_t *q)
__DPROTO(void,,wa_priority_queue_destroy,wa_priority_queue_t *q)
__DPROTO(int,,wa_priority_queue_empty,wa_priority_queue_t *q)
...
__DPROTO(size_t,,wa_priority_queue_size,wa_priority_queue_t *q)
