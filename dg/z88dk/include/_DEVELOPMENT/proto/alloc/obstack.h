...
__DPROTO(void,*,obstack_1grow_fast,struct obstack *ob,int c)
...
__DPROTO(void,*,obstack_base,struct obstack *ob)
...
__DPROTO(void,*,obstack_finish,struct obstack *ob)
...
__DPROTO(void,*,obstack_next_free,struct obstack *ob)
__DPROTO(size_t,,obstack_object_size,struct obstack *ob)
__DPROTO(size_t,,obstack_room,struct obstack *ob)
