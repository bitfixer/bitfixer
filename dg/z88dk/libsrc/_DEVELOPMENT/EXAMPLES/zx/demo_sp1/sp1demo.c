...
// while running press any key to reset

// zcc +zx -vn -clib=new -startup=31 sp1demo.c graphics.asm collision.asm -o sp1demo
// zcc +zx -vn -SO3 -clib=sdcc_iy -startup=31 --max-allocs-per-node200000 sp1demo.c graphics.asm collision.asm -o sp1demo
// appmake +zx -b sp1demo_CODE.bin -o demo.tap --org 32768 --blockname sp1demo
