...
.kbd_transtbl
   ...
   ; the following keys are unshifted
   ...
   ; the following keys are CAPS SHIFTed
   ...
   ; the following keys are SYM SHIFTed
   ...
   ; the following keys are CAPS SHIFTed and SYM SHIFTed ("CTRL" key)
