...
;          B = current x coordinate (relative to bounds rect IX)
;          C = current y coordinate (relative to bounds rect IX)
...
;       IX+0 = row coordinate   \
;       IX+1 = col coordinate   |  Bounds Rectangle
;       IX+2 = width in chars   |  Must Fit On Screen
;       IX+3 = height in chars  /
; exit : same as enter
