...
// 04.2006 aralbrec
//
// As ex1.c but this time with LOAD-type sprites.  The only
// change is in the sprite create calls where a different
// draw function is specified.  LOAD-type sprites completely
// overwrite the character cell graphics underneath them
// which is why blank areas are seen. 
/////////////////////////////////////////////////////////////

// zcc +ts2068 -vn ex2c.c -o ex2c.bin -create-app -lsp1 -lmalloc
