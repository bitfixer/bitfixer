...
// zcc +ts2068 -vn ex2e.c -o ex2e.bin -create-app -lsp1 -lmalloc
...
main()
{
   ...
   for (i=0; i!=10; i++) {
      ...
      s = sprtbl[i].s = sp1_CreateSpr(SP1_DRAW_LOAD2LBIM, SP1_TYPE_2BYTE | SP1_TYPE_OCCLUDE | SP1_TYPE_BGNDCLR, 3, 0, i);
      sp1_AddColSpr(s, SP1_DRAW_LOAD2, SP1_TYPE_OCCLUDE | SP1_TYPE_BGNDCLR, 48, i);
      sp1_AddColSpr(s, SP1_DRAW_LOAD2RBIM, SP1_TYPE_OCCLUDE | SP1_TYPE_BGNDCLR, 0, i);
